    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
          ...
          <a href="" class="brand-link">
            <span class="brand-text font-weight-light">ZRP Self Equiping System</span>
          </a>
                  ...
                  <div class="card">
                    <div class="card-header p-2">
                      <ul class="nav nav-pills">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#settings" data-toggle="tab">Upload Content</a></li>
                        <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">Search Content</a></li>
                        <li class="nav-item"><a class="nav-link" href="#viewcontent" data-toggle="tab">View Content</a></li>
                        ...
                        <div class="tab-pane" id="settings">
                          <form class="form-horizontal">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                <input type="name" class="form-control" required id="inputName" placeholder="Name">
                              </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputName" class="col-sm-2 col-form-label">Reference</label>
                                <div class="col-sm-10">
                                  <input type="name" class="form-control" required id="inputName" placeholder="Reference Number">
                                </div>
                              </div>
                            <div class="form-group row">
                              <label for="inputExperience" class="col-sm-2 col-form-label">Description</label>
                              <div class="col-sm-10">
                                <textarea class="form-control" id="inputExperience" required placeholder="Experience"></textarea>
                              </div>
                            </div>
                            <div class="form-group row">
                              <label for="inputSkills" class="col-sm-2 col-form-label">File Content</label>
                              <div class="col-sm-10">
                                <input type="file" class="form-control" required id="inputSkills" placeholder="File">
                              </div>
                            </div>
                            <div class="form-group row">
...
<table id="myTable">
  ...
  <tr>
    <td>Zimbabwe Consititution Amendment</td>
    <td>RE237387899I0001</td>
    <td>This is the Zimbabwe Consititution Amendment of 2013</td>
    <td><a class="nav-link" href="#viewcontent" data-toggle="tab"><input type="button" class="btn btn-success" value="view"></a></td>
  </tr>
